...
_SIZE_ASPECT_HINT = {
    # אוצר המילים החדש (רשת 6 עמודות × 4 טורים)
    "third": "הרכב את התמונה ביחס כמעט ריבועי (פאנל צר). ודא שהנושא והדמויות נמצאים במלואם במרכז הקדר.",
    "half": "הרכב את התמונה ביחס רוחבי מתון (landscape, בערך 3:2). שמור את הדמויות במלואן בקדר.",
    "two_thirds": "הרכב את התמונה ביחס רוחבי (landscape, בערך 16:9). פרוס את הדמויות לרוחב ושמור עליהן במלואן.",
    "full": "הרכב את התמונה ברצועה פנורמית רחבה מאוד (panoramic, בערך 21:9). מתאים לנוף או רגע מבסס; שמור דמויות במלואן.",
    "tall": "הרכב את התמונה ביחס אנכי-גבוה (portrait, בערך 1:2). מקם את הדמויות לאורך הציר האנכי ושמור עליהן במלואן.",
    "big": "הרכב תמונה גדולה ודרמטית ביחס פורטרט מתון (בערך 3:4) עם קומפוזיציה עשירה בפרטים.",
    "splash": "הרכב תמונה דרמטית ומרהיבה בגודל עמוד שלם (portrait, בערך 3:4) עם קומפוזיציה רחבה ועשירה.",
    # תאימות לאחור לערכים ישנים
    "regular": "הרכב את התמונה ביחס ריבועי (1:1). ודא שהדמויות והאלמנטים המרכזיים נמצאים במלואם בקדר.",
    "wide": "הרכב את התמונה ביחס רוחבי (landscape, בערך 16:9). פרוס את הדמויות לרוחב ושמור עליהן במלואן.",
}
